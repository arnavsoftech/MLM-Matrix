...
<?php echo form_open_multipart(admin_url('categories/add_blog/' . $cat -> id), array('class' => 'form-horizontal')); ?>
        ...
        <div class="tab-pane active" id="description_tab">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Save</button> <a href="<?php echo admin_url('categories/blog'); ?>" class="btn btn-secondary">Cancel</a>
